        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-sm font-bold text-slate-900 dark:text-white tracking-tight">AI Command Center</h3>
              <span className="flex h-2 w-2 relative">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
              </span>
            </div>
            <p className="text-[11px] text-slate-500 dark:text-slate-400">Natural language database operations & reasoning</p>
          </div>
        </div>
        ...
        {messages.map((msg) => (
          ...
          >
            ...
            >
              ...
              <span className="text-[10px] text-slate-400 dark:text-slate-500 mt-2 block text-right">
                {msg.timestamp}
              </span>
            </div>
          </div>
